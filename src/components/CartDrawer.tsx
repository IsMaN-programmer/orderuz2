...
export function CartDrawer({ isOpen, onClose }: CartDrawerProps) {
  ...
  const handlePlaceOrder = () => {
    ...
    // Here would be API call to place order
  };
  ...
  return (
    <Sheet open={isOpen} onOpenChange={(open) => !open && onClose()}>
      <SheetContent 
        side="right" 
        className="w-full sm:max-w-md flex flex-col p-0 bg-background/95 backdrop-blur-2xl border-l border-border/40 shadow-2xl [&_button[type='button']]:hidden"
      >
        {/* Header Section */}
