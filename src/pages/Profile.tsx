    ...
    <div className="h-screen flex flex-col bg-background overflow-hidden">
      ...
      >
        <div className="absolute inset-0 overflow-hidden">
          ...
          />
          <div className="absolute inset-0 bg-gradient-to-b from-background/50 via-background/70 to-transparent" />
        </div>

        <div className="relative container mx-auto px-6 pt-12 flex flex-col items-center">
          <motion.div 
      ...
      <div className="flex-1 overflow-y-auto">
        ...
        <motion.div 
          ...
          initial="hidden"
          animate="visible"
          className="container mx-auto px-4 -mt-6 mb-6 relative z-10"
        >
            ...
            <motion.div key={i} variants={staggerItem}>
              <Card className="bg-card/80 backdrop-blur-md border-border/50 shadow-lg">
                <CardContent className="p-4 flex flex-col items-center justify-center text-center">
                  ...
                  <span className="text-xl font-bold font-mono leading-none">{stat.value}</span>
                  <span className="text-[10px] text-muted-foreground uppercase tracking-wider mt-1.5">{stat.label}</span>
                </CardContent>
              </Card>
            </motion.div>
          ))}
      ...
      <motion.div 
        ...
        animate="visible"
        variants={staggerContainer}
        className="container mx-auto px-4 mt-6 pb-24 space-y-6"
      >
          {/* Account Section */}
          <section>
