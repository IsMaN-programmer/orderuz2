...
export default function Profile() {
  ...
  const handleAuth = async () => {
    if (authMode === 'register') {
      ...
      try {
        await user.register(authForm.name, authForm.email, authForm.password, selectedAccountType);
      ...
      try {
        await user.login(authForm.email, authForm.password, selectedAccountType);
