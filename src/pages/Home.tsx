...
export default function Home() {
  ...
  return (
    <main className="relative h-screen w-full bg-black overflow-hidden">
      ...
      <div className="absolute top-0 left-0 w-full pt-12 pb-6 px-6 flex justify-between items-center z-40 pointer-events-none">
        {/* Logo on the left */}
        <div className="pointer-events-none">
          <span className="text-xl font-black tracking-tight text-white drop-shadow-lg flex items-baseline">
        ...
        <div className="flex items-center gap-4">
          <motion.button 
            ...
            className={`font-semibold text-sm pointer-events-auto transition-colors relative ${
