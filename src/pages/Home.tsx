...
export default function Home() {
  ...
  return (
    <main className="relative h-screen w-full bg-black overflow-hidden">
      ...
      {/* Top Navigation Tabs Overlay - Logo and Tabs on same line */}
      <div className="absolute top-0 left-0 w-full pt-12 pb-6 px-4 sm:px-6 z-40 pointer-events-none">
        <div className="flex justify-between items-center gap-2">
          {/* Logo on the left */}
          <div className="pointer-events-none">
            <span className="text-xl sm:text-2xl font-black tracking-tight text-white drop-shadow-lg flex items-baseline">
          ...
          <div className="flex items-center gap-3 sm:gap-6">
            <motion.button 
              ...
              className={`font-semibold text-base sm:text-lg pointer-events-auto transition-colors relative whitespace-nowrap ${
