...
// ─── CORS ────────────────────────────────────────────────────────────────────
const corsOptions = {
  origin: true, // Allow all origins (required for Capacitor mobile app)
  credentials: true,
...
const MAX_VIDEO_DATA_URL_LENGTH = toPositiveInt(process.env.MAX_VIDEO_DATA_URL_LENGTH, 110_000_000);
